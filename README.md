...
[Download](https://repository-saucelabs.forge.cloudbees.com/release/com/saucelabs/teamcity/sauceplugin/1.31/sauceplugin-1.31.zip) the plugin zip file and copy it into your ~/.BuildServer/plugins directory
