...
[Download](https://repository-saucelabs.forge.cloudbees.com/release/com/saucelabs/teamcity/sauceplugin/1.12/sauceplugin-1.12.zip) the plugin zip file and copy it into your ~/.BuildServer/plugins directory
